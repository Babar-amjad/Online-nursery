...
const Services = () => {
  ...
  <div className="py-8  px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mx-4 items-center text-center mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white md:pl-44 sm:pl-4 sm:text-xl md:text-4xl">Our Services</h2>
          <p className="text-black sm:text-xl dark:text-gray-400 md:pl-56 sm:pl-4">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
