        ...
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            <div classNameName="items-center justify-between">
              <img src="https://media.istockphoto.com/id/694076680/photo/sustainable-development-concept-3d-illustration-on-wooden-background.webp?b=1&s=170667a&w=0&k=20&c=C4SAdDUKixro7C-AUYjRbZv0n4z3RTIbytnjKZ62rT8=" className=" h-12 rounded-xl " alt="logo" />
